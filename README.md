...
5. **Inicia el servidor de desarrollo:**
   ...
   Esto iniciará el proyecto en modo desarrollo y deberías poder acceder a la aplicación en tu navegador en [http://localhost:5173](http://localhost:5173).

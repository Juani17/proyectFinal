...
export const PopUpSucursal: React.FC<SucursalModalProps> = ({ isOpen, onClose, onAddSucursal }) => {
        ...
        isOpen ? (
            <Modal>
                <div className={styles.containerForm}>
                    <form onSubmit={(e) => { e.preventDefault(); onAddSucursal(sucursalData); onClose(); }} className={styles.Styleform}>
